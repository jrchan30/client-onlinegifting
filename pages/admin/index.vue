          ...
          <div id="sidenav-collapse-main" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                ...
                <div id="navbar-dashboards" class="collapse show">
              ...
              <li class="nav-item">
                ...
                <div id="navbar-examples" class="collapse">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <div id="navbar-components" class="collapse">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <div id="navbar-maps" class="collapse">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
