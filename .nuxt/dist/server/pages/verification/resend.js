...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/verification/resend.vue?vue&type=template&id=5007bab3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_vm._ssrNode("<div class=\"row justify-content-center\">","</div>",[_vm._ssrNode("<div class=\"col-11 col-md-6 col-lg-3 my-3 p-0\">","</div>",[_c('CardForm',{attrs:{"loading":_vm.loading,"alert-class":_vm.alert.class,"alert-show":_vm.alert.show},on:{"formSubmitted":_vm.formSubmit},scopedSlots:_vm._u([{key:"alert",fn:function(){return [_c('span',{domProps:{"innerHTML":_vm._s(_vm.alert.text)}})]},proxy:true},{key:"title",fn:function(){return [_vm._v(" Resend ")]},proxy:true},{key:"fields",fn:function(){return _vm._l((_vm.form),function(value,key,index){return _c('div',{key:index,staticClass:"px-2"},[_c('label',{staticClass:"text-capitalize text-primary float-left mb-0",attrs:{"for":value.id}},[_vm._v(_vm._s(key))]),_vm._v(" "),_c('InputField',{staticClass:"pb-3",attrs:{"id":value.id,"errors":_vm.errors,"name":key,"key-value":value.val,"icon":value.icon,"placeholder":value.placeholder,"input-type":value.type},on:{"new-input":function($event){value.val = $event}}})],1)})},proxy:true},{key:"btnSubmit",fn:function(){return [_vm._v(" Resend ")]},proxy:true}])})],1)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/verification/resend.vue?vue&type=template&id=5007bab3&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/verification/resend.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var resendvue_type_script_lang_js_ = ({
  middleware: ['guest'],
  ...
  methods: {
    async formSubmit() {
      ...
      try {
        ...
        var _e$response$data, _e$response$data$erro, _e$response$data$erro2;
...
// CONCATENATED MODULE: ./pages/verification/resend.vue?vue&type=script&lang=js&
 /* harmony default export */ var verification_resendvue_type_script_lang_js_ = (resendvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/verification/resend.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  verification_resendvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var resend = __webpack_exports__["default"] = (component.exports);
