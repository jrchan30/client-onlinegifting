...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/products/index.vue?vue&type=template&id=0fe95561&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"d-flex justify-content-between\">","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills\"><li class=\"nav-item\"><a href=\"#\" class=\"nav-link active\">Most Recent</a></li> <li class=\"nav-item\"><a href=\"#\" class=\"nav-link\">Most Likes</a></li> <li class=\"nav-item\"><a href=\"#\" class=\"nav-link\">Top Rated</a></li></ul> "),_vm._ssrNode("<div>","</div>",[_c('vs-button',{attrs:{"flat":"","icon":""},on:{"click":function($event){_vm.activeFilter = !_vm.activeFilter}}},[_c('i',{staticClass:"bx bx-menu"})])],1)],2),_vm._ssrNode(" "),(_vm.$fetchState.pending)?_vm._ssrNode("<div class=\"row pt-5\">","</div>",_vm._l((12),function(index){return _vm._ssrNode("<div class=\"col-6 col-sm-4 col-lg-3 pb-4\">","</div>",[_c('content-placeholders',{attrs:{"rounded":true}},[_c('content-placeholders-img'),_vm._v(" "),_c('content-placeholders-heading')],1)],1)}),0):_vm._ssrNode("<div class=\"pt-5\">","</div>",[_c('CardMain',{attrs:{"items":_vm.PRODUCTS.data,"item-type":'products',"store-state":'products'}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"d-flex justify-content-center pt-4\">","</div>",[_c('Pagination',{attrs:{"action":'products'}})],1)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"position-sticky\" style=\"z-index: 100\">","</div>",[_c('vs-sidebar',{attrs:{"right":"","open":_vm.activeFilter},on:{"update:open":function($event){_vm.activeFilter=$event}},scopedSlots:_vm._u([{key:"logo",fn:function(){return [_c('div',{staticClass:"pt-5"})]},proxy:true}]),model:{value:(_vm.active),callback:function ($$v) {_vm.active=$$v},expression:"active"}},[_vm._v(" "),_c('vs-sidebar-item',{attrs:{"id":"home"},scopedSlots:_vm._u([{key:"icon",fn:function(){return [_c('i',{staticClass:"bx bx-home"})]},proxy:true}])},[_vm._v("\n        Home\n      ")]),_vm._v(" "),_c('vs-sidebar-item',{attrs:{"id":"market"},scopedSlots:_vm._u([{key:"icon",fn:function(){return [_c('i',{staticClass:"bx bx-grid-alt"})]},proxy:true}])},[_vm._v("\n        Market Overview\n      ")])],1)],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/products/index.vue?vue&type=template&id=0fe95561&
...
installComponents(component, {CardMain: __webpack_require__(77).default,Pagination: __webpack_require__(80).default})
