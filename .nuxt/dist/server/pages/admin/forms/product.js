...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/forms/product.vue?vue&type=template&id=d6f34926&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<form>","</form>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-6\">","</div>",[_vm._ssrNode("<div class=\"card-wrapper\">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-header\"><h3 class=\"mb-0\">Input product</h3></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode((_vm._ssrList((_vm.fields),function(field,index){return ("<div"+(_vm._ssrClass(null,field.class))+"><div class=\"form-group\"><div class=\"input-group input-group-merge\"><div class=\"input-group-prepend\"><span class=\"input-group-text\"><i"+(_vm._ssrClass(null,field.icon))+"></i></span></div> "+(((field.type)==='checkbox')?("<input"+(_vm._ssrAttr("placeholder",field.placeholder))+" type=\"checkbox\""+(_vm._ssrAttr("checked",Array.isArray(field.value)?_vm._i(field.value,null)>-1:(field.value)))+" class=\"form-control\">"):((field.type)==='radio')?("<input"+(_vm._ssrAttr("placeholder",field.placeholder))+" type=\"radio\""+(_vm._ssrAttr("checked",_vm._q(field.value,null)))+" class=\"form-control\">"):("<input"+(_vm._ssrAttr("placeholder",field.placeholder))+(_vm._ssrAttr("type",field.type))+(_vm._ssrAttr("value",(field.value)))+" class=\"form-control\">"))+" "+((field.appendable)?("<div class=\"input-group-append\"><span class=\"input-group-text\"><small class=\"font-weight-bold\">"+_vm._ssrEscape(_vm._s(field.appendable_value))+"</small></span></div>"):"<!---->")+"</div></div></div>")}))+" <div class=\"card-header col-12\"><h3 class=\"mb-0\">Categories</h3></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_c('v-select',{staticStyle:{},attrs:{"multiple":"","label":"name","required":"","reduce":function (name) { return name.id; },"options":_vm.CATEGORIES},model:{value:(_vm.categories),callback:function ($$v) {_vm.categories=$$v},expression:"categories"}})],1)],2)])],2)])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-6\">","</div>",[_vm._ssrNode("<div class=\"card-wrapper\">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-header\"><h3 class=\"mb-0\">Images</h3></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",_vm._l((_vm.images),function(image,index){return _vm._ssrNode("<div class=\"col-6 col-md-4 mt-2\">","</div>",[_c('picture-input',{ref:"pictureInput",refInFor:true,attrs:{"width":"130","height":"130","size":"10","margin":"16","z-index":10,"button-class":"btn mb-0 mt-1","remove-button-class":"btn my-0","radius":"5","removable":true,"custom-strings":{
                      upload: '<h1>Bummer!</h1>',
                      drag: 'Drag an image',
                      remove: 'Remove',
                      change: 'Change',
...
// CONCATENATED MODULE: ./pages/admin/forms/product.vue?vue&type=template&id=d6f34926&
